...
export default function JobDetail() {
  ...
  const fetchBooking = useCallback(async () => {
    try {
      ...
      setBooking(res.data?.data || res.data?.booking || res.data);
    } catch (err) {
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6 relative">
        ...
        <div className="relative">
          ...
          <div
            ...
            style={{
              width: `${
                ((STATUS_STEPS.findIndex((s) => s.key === booking.status) + 1) /
                  STATUS_STEPS.length) *
                100
              }%`,
            }}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between py-2 border-b border-gray-50">
                ...
                <span className="font-medium text-gray-900">
                  {new Date(booking.scheduledDate || booking.date || booking.createdAt).toLocaleDateString()}
                </span>
              </div>
          ...
          {(booking.specialRequirements || booking.notes || booking.description) && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2 text-gray-600">
                ...
                {booking.customerArea || booking.area || 'Area not specified'}
              </div>
              {booking.customerPhone && (
                <div className="flex items-center gap-2 text-gray-600">
                  <span className="text-gray-400">Phone available after confirmation</span>
                </div>
              )}
            </div>
          </div>
          ...
          {/* Location */}
          {(booking.latitude || booking.location) && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              <h3 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
              ...
              <div className="h-48 bg-gray-100 rounded-lg flex items-center justify-center relative overflow-hidden">
                ...
                <div className="relative text-center">
                  ...
                  <p className="text-xs text-gray-600">
                    {booking.latitude || booking.location?.lat || '—'},{' '}
                    {booking.longitude || booking.location?.lng || '—'}
                  </p>
                </div>
              </div>
              {booking.address && (

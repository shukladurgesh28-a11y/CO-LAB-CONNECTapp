      ...
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="space-y-4" aria-label="Loading workers">
              {[...Array(5)].map((_, i) => (
                <div key={i} className="flex items-center gap-4">
                  <div className="cc-skeleton w-12 h-12 !rounded-full"></div>
                  <div className="flex-1">
                    <div className="cc-skeleton h-4 w-1/4 mb-2"></div>
                    <div className="cc-skeleton h-3 w-1/3"></div>
                  </div>
                </div>
              ))}
            </div>
